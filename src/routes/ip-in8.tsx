...
function Page() {
  ...
  useEffect(() => { runFullAustcoDiagnosis(siteConfig, undefined, 0).then(r => setIssues(r.issues.filter(i => i.id === "IP-IN8" || i.module.toLowerCase().includes("IP-IN8".toLowerCase())))); }, []);
