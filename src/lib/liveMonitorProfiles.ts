...
export const LIVE_MONITOR_PROFILES: LiveMonitorProfile[] = [
  ...
  { key: "license-service", label: "License Service", kind: "service", protocol: "tcp", port: 443, ssh: { username: "admin", port: 22 } },
  { key: "mqtt-broker", label: "MQTT Broker", kind: "broker", protocol: "mqtt-fresh", port: 1883, mqttTopics: ["xcare/#"], critical: true },
  { key: "ws-mqtt-adapter", label: "WebSocket MQTT Adapter", kind: "service", protocol: "tcp", port: 9001 },
  ...
  { key: "file-server", label: "File Server", kind: "service", protocol: "tcp", port: 22, ssh: { username: "admin", port: 22 } },
  ...
  { key: "ipc-webmin", label: "IPC Webmin", kind: "service", protocol: "webmin", port: 10000, tls: true, ssh: { username: "tech", port: 22 } },
